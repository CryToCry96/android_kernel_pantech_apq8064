...
#define FEATURE_PANTECH_WLAN_FTM_TX_OFFSET	// 20140725 SeungGook Lee, FEATURE_PANTECH_WLAN_FTM_TX_OFFSET feature should be only enable for H/W local test
/* WLAN Model Feature */
//#if defined(T_EF48S) || defined(T_EF49K) || defined(T_EF50L)
...
#ifdef FEATURE_PANTECH_PMIC_LK
#define FEATURE_SKIP_SELINUX_INITIALIZE_DURING_OFFLINE_CHARGING //P11536-SHPARK
#endif
#endif
